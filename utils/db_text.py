...
tables_text = """
auth.users: phone (text), updated_at (timestamp with time zone), created_at (timestamp with time zone), is_super_admin (boolean), is_anonymous (boolean), deleted_at (timestamp with time zone), is_sso_user (boolean), raw_user_meta_data (jsonb), raw_app_meta_data (jsonb), last_sign_in_at (timestamp with time zone), reauthentication_sent_at (timestamp with time zone), email_change_sent_at (timestamp with time zone), email_change (character varying), email_change_token_new (character varying), recovery_sent_at (timestamp with time zone), recovery_token (character varying), confirmation_sent_at (timestamp with time zone), confirmation_token (character varying), invited_at (timestamp with time zone), email_change_token_current (character varying), encrypted_password (character varying), email (character varying), role (character varying), aud (character varying), id (uuid), instance_id (uuid), email_change_confirm_status (smallint), banned_until (timestamp with time zone), reauthentication_token (character varying), email_confirmed_at (timestamp with time zone), confirmed_at (timestamp with time zone), phone_change_sent_at (timestamp with time zone), phone_change_token (character varying), phone_change (text), phone_confirmed_at (timestamp with time zone)
historique.action_statut: previous_concerne (boolean), previous_avancement_detaille (ARRAY), concerne (boolean), modified_by (uuid), previous_modified_by (uuid), modified_at (timestamp with time zone), previous_modified_at (timestamp with time zone), collectivite_id (integer), action_id (character varying), avancement (USER-DEFINED), previous_avancement (USER-DEFINED), avancement_detaille (ARRAY), id (integer)
historique.fiche_action: niveau_priorite (text), id (integer), fiche_id (integer), titre (character varying), previous_titre (character varying), description (character varying), previous_description (character varying), piliers_eci (ARRAY), previous_piliers_eci (ARRAY), objectifs (character varying), previous_objectifs (character varying), resultats_attendus (ARRAY), previous_resultats_attendus (ARRAY), cibles (ARRAY), previous_cibles (ARRAY), ressources (character varying), previous_ressources (character varying), financements (text), previous_financements (text), budget_previsionnel (numeric), previous_budget_previsionnel (numeric), statut (text), previous_statut (text), previous_niveau_priorite (text), date_debut (timestamp with time zone), previous_date_debut (timestamp with time zone), date_fin_provisoire (timestamp with time zone), previous_date_fin_provisoire (timestamp with time zone), amelioration_continue (boolean), previous_amelioration_continue (boolean), calendrier (character varying), previous_calendrier (character varying), maj_termine (boolean), previous_maj_termine (boolean), collectivite_id (integer), created_at (timestamp with time zone), modified_at (timestamp with time zone), previous_modified_at (timestamp with time zone), modified_by (uuid), previous_modified_by (uuid), restreint (boolean), previous_restreint (boolean), deleted (boolean)
historique.fiche_action_pilote: fiche_historise_id (integer), previous (boolean), user_id (uuid), tag_nom (text), id (integer)
labellisation.action_audit_state: id (integer), audit_id (integer), action_id (character varying), statut (USER-DEFINED), avis (text), ordre_du_jour (boolean), modified_at (timestamp with time zone), modified_by (uuid), collectivite_id (integer)
labellisation.audit: referentiel (USER-DEFINED), collectivite_id (integer), id (integer), demande_id (integer), valide_labellisation (boolean), date_cnl (timestamp with time zone), valide (boolean), date_fin (timestamp with time zone), date_debut (timestamp with time zone), clos (boolean)
labellisation.demande: demandeur (uuid), envoyee_le (timestamp with time zone), sujet (USER-DEFINED), modified_at (timestamp with time zone), date (timestamp with time zone), en_cours (boolean), id (integer), collectivite_id (integer), referentiel (USER-DEFINED), etoiles (USER-DEFINED), associated_collectivite_id (integer)
labellisation.etoile_meta: prochaine_etoile (USER-DEFINED), long_label (character varying), short_label (character varying), min_realise_percentage (integer), min_realise_score (double precision), etoile (USER-DEFINED)
labellisation.preuve_base: titre (text), commentaire (text), lien (jsonb), modified_at (timestamp with time zone), modified_by (uuid), collectivite_id (integer), fichier_id (integer), url (text)
public.action_commentaire: collectivite_id (integer), modified_at (timestamp with time zone), modified_by (uuid), commentaire (text), action_id (character varying)
public.action_definition: perimetre_evaluation (text), pourcentage (double precision), points (double precision), preuve (text), ressources (text), exemples (text), contexte (text), description (text), nom (text), identifiant (text), referentiel (USER-DEFINED), action_id (character varying), modified_at (timestamp with time zone), expr_score (text), referentiel_version (character varying), categorie (USER-DEFINED), reduction_potentiel (text), referentiel_id (character varying)
public.action_definition_tag: action_id (character varying), referentiel_id (character varying), tag_ref (character varying)
public.action_discussion_feed: action_id (character varying), status (USER-DEFINED), commentaires (ARRAY), id (integer), collectivite_id (integer), created_by (uuid), created_at (timestamp with time zone), modified_at (timestamp with time zone)
public.action_pilote: collectivite_id (integer), action_id (character varying), tag_id (integer), user_id (uuid)
public.action_relation: id (character varying), referentiel (USER-DEFINED), parent (character varying)
public.action_score_indicateur_valeur: action_id (character varying), indicateur_id (integer), indicateur_valeur_id (integer), type_score (text), collectivite_id (integer)
public.action_service: action_id (character varying), collectivite_id (integer), service_tag_id (integer)
public.action_statut: collectivite_id (integer), action_id (character varying), concerne (boolean), modified_by (uuid), modified_at (timestamp with time zone), avancement_detaille (ARRAY), avancement (USER-DEFINED)
public.audit: referentiel (USER-DEFINED), id (integer), collectivite_id (integer), demande_id (integer), date_debut (timestamp with time zone), date_fin (timestamp with time zone), valide (boolean), date_cnl (timestamp with time zone), valide_labellisation (boolean), clos (boolean)
public.axe: modified_at (timestamp with time zone), id (integer), nom (text), collectivite_id (integer), parent (integer), created_at (timestamp with time zone), modified_by (uuid), plan (integer), type (integer), panier_id (uuid), description (text)
...
public.collectivite: nom (text), type (text), commune_code (character varying), siren (character varying), departement_code (character varying), region_code (character varying), nature_insee (text), population (integer), dans_aire_urbaine (boolean), nic (character varying), id (integer), created_at (timestamp with time zone), modified_at (timestamp with time zone), access_restreint (boolean)
public.collectivite_banatic_competence: competence_code (integer), collectivite_id (integer)
public.collectivite_banatic_type: nom (text), type (text), id (text)
public.collectivite_bucket: bucket_id (text), collectivite_id (integer)
public.collectivite_carte_identite: population_source (text), is_cot (boolean), population_totale (integer), collectivite_id (integer), nom (text), type_collectivite (text), code_siren_insee (character varying), region_name (character varying), departement_name (character varying)
public.collectivite_identite: type (ARRAY), id (integer), population (ARRAY), localisation (ARRAY)
...
public.comparaison_scores_audit: referentiel (USER-DEFINED), action_id (character varying), collectivite_id (integer), courant (USER-DEFINED), pre_audit (USER-DEFINED)
public.cot: actif (boolean), collectivite_id (integer), signataire (integer)
public.effet_attendu: nom (text), notice (text), id (integer)
public.fiche_action: budget_previsionnel (numeric), id (integer), titre (character varying), description (character varying), piliers_eci (ARRAY), objectifs (character varying), resultats_attendus (ARRAY), cibles (ARRAY), ressources (character varying), financements (text), statut (USER-DEFINED), niveau_priorite (USER-DEFINED), date_debut (timestamp with time zone), date_fin_provisoire (timestamp with time zone), amelioration_continue (boolean), calendrier (character varying), maj_termine (boolean), collectivite_id (integer), created_at (timestamp with time zone), modified_by (uuid), restreint (boolean), instance_gouvernance (text), participation_citoyenne (text), participation_citoyenne_type (character varying), temps_de_mise_en_oeuvre_id (integer), created_by (uuid), parent_id (integer), deleted (boolean), modified_at (timestamp with time zone)
public.fiche_action_action: fiche_id (integer), action_id (character varying)
public.fiche_action_axe: fiche_id (integer), axe_id (integer)
public.fiche_action_budget: annee (integer), unite (text), id (integer), fiche_id (integer), type (text), est_etale (boolean), budget_reel (numeric), budget_previsionnel (numeric)
public.fiche_action_effet_attendu: effet_attendu_id (integer), fiche_id (integer)
public.fiche_action_etape: created_by (uuid), modified_by (uuid), created_at (timestamp with time zone), modified_at (timestamp with time zone), ordre (integer), nom (text), fiche_id (integer), id (integer), realise (boolean)
public.fiche_action_financeur_tag: fiche_id (integer), montant_ttc (integer), id (integer), financeur_tag_id (integer)
public.fiche_action_import_csv: num_action (text), axe (text), sous_axe (text), sous_sous_axe (text), titre (text), description (text), objectifs (text), resultats_attendus (text), cibles (text), structure_pilote (text), moyens (text), partenaires (text), personne_referente (text), elu_referent (text), financements (text), budget (text), statut (text), priorite (text), date_debut (text), date_fin (text), amelioration_continue (text), calendrier (text), notes (text), collectivite_id (text), plan_nom (text), service (text), financeur_un (text), montant_un (text), financeur_deux (text), montant_deux (text), financeur_trois (text), montant_trois (text)
public.fiche_action_indicateur: indicateur_id (integer), fiche_id (integer)
public.fiche_action_libre_tag: fiche_id (integer), libre_tag_id (integer), created_at (timestamp with time zone), created_by (uuid)
public.fiche_action_lien: fiche_deux (integer), fiche_une (integer)
public.fiche_action_note: modified_by (uuid), id (integer), created_by (uuid), fiche_id (integer), date_note (date), note (text), modified_at (timestamp with time zone), created_at (timestamp with time zone)
public.fiche_action_partenaire_tag: partenaire_tag_id (integer), fiche_id (integer)
public.fiche_action_personne_pilote: user_id (uuid), tag_id (integer), collectivite_id (integer), nom (text)
public.fiche_action_personne_referente: tag_id (integer), collectivite_id (integer), nom (text), user_id (uuid)
...
public.fiche_action_sharing: fiche_id (integer), collectivite_id (integer), created_at (timestamp with time zone), created_by (uuid)
public.fiche_action_sous_thematique: fiche_id (integer), thematique_id (integer)
...
public.indicateur_artificialisation: inconnue (double precision), collectivite_id (integer), total (double precision), activite (double precision), habitat (double precision), mixte (double precision), routiere (double precision), ferroviaire (double precision)
public.indicateur_categorie_tag: categorie_tag_id (integer), indicateur_id (integer)
public.indicateur_collectivite: commentaire (text), confidentiel (boolean), favoris (boolean), modified_by (uuid), modified_at (timestamp with time zone), indicateur_id (integer), collectivite_id (integer)
public.indicateur_definition: groupement_id (integer), collectivite_id (integer), identifiant_referentiel (text), titre (text), titre_long (text), description (text), unite (text), borne_min (double precision), borne_max (double precision), participation_score (boolean), sans_valeur_utilisateur (boolean), valeur_calcule (text), modified_at (timestamp with time zone), created_at (timestamp with time zone), modified_by (uuid), created_by (uuid), titre_court (text), version (character varying), precision (integer), expr_cible (text), expr_seuil (text), libelle_cible_seuil (text), id (integer)
public.indicateur_groupe: parent (integer), enfant (integer)
public.indicateur_objectif: date_valeur (date), formule (text), indicateur_id (integer)
public.indicateur_pilote: indicateur_id (integer), user_id (uuid), tag_id (integer), collectivite_id (integer), id (integer)
public.indicateur_service_tag: service_tag_id (integer), collectivite_id (integer), indicateur_id (integer)
public.indicateur_source: libelle (text), ordre_affichage (integer), id (text)
public.indicateur_source_metadonnee: source_id (text), date_version (timestamp without time zone), nom_donnees (text), diffuseur (text), producteur (text), methodologie (text), limites (text), id (integer)
public.indicateur_source_source_calcul: source_calcul_id (text), source_id (text)
public.indicateur_sous_thematique: indicateur_id (integer), sous_thematique_id (integer)
public.indicateur_thematique: indicateur_id (integer), thematique_id (integer)
public.indicateur_valeur: objectif (double precision), id (integer), indicateur_id (integer), collectivite_id (integer), date_valeur (date), metadonnee_id (integer), resultat (double precision), resultat_commentaire (text), objectif_commentaire (text), estimation (double precision), modified_at (timestamp with time zone), created_at (timestamp with time zone), modified_by (uuid), created_by (uuid), calcul_auto (boolean), calcul_auto_identifiants_manquants (ARRAY)
public.labellisation: obtenue_le (timestamp without time zone), id (integer), referentiel (USER-DEFINED), collectivite_id (integer), audit_id (integer), score_programme (double precision), score_realise (double precision), etoiles (integer), annee (double precision)
public.libre_tag: created_at (timestamp with time zone), id (integer), created_by (uuid), collectivite_id (integer), nom (text)
...
public.plan_pilote: plan_id (integer), user_id (uuid), created_at (timestamp with time zone), created_by (uuid), tag_id (integer)
public.plan_referent: tag_id (integer), user_id (uuid), created_at (timestamp with time zone), created_by (uuid), plan_id (integer)
public.private_collectivite_membre: modified_at (timestamp with time zone), created_at (timestamp with time zone), champ_intervention (ARRAY), details_fonction (text), fonction (USER-DEFINED), user_id (uuid), collectivite_id (integer), est_referent (boolean)
public.private_utilisateur_droit: user_id (uuid), collectivite_id (integer), active (boolean), created_at (timestamp with time zone), modified_at (timestamp with time zone), niveau_acces (USER-DEFINED), invitation_id (uuid), id (integer)
public.referentiel_definition: nom (character varying), id (character varying), locked (boolean), modified_at (timestamp with time zone), created_at (timestamp with time zone), hierarchie (ARRAY), version (character varying)
public.referentiel_tag: nom (character varying), ref (character varying), type (character varying)
public.score_snapshot: type_jalon (character varying), collectivite_id (integer), referentiel_id (character varying), referentiel_version (character varying), audit_id (integer), date (timestamp with time zone), ref (character varying), nom (character varying), point_fait (double precision), point_programme (double precision), point_pas_fait (double precision), point_potentiel (double precision), referentiel_scores (jsonb), personnalisation_reponses (jsonb), created_by (uuid), created_at (timestamp with time zone), modified_by (uuid), modified_at (timestamp with time zone), etoiles (integer)
public.service_tag: collectivite_id (integer), nom (text), id (integer)
